...
from sqlalchemy.types import Float, String, Datatime
...
def load_to_postgres(engine, clean_data):
    ...
    clean_data.to_sql(name='tabel_order', con=engine, if_exists='replace', index=False, schema='public', dtype=df_schema, method=None, chunksize=5000)
